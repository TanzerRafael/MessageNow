...
exports.getGroups = function (userName) { return __awaiter(void 0, void 0, void 0, function () {
    var grps, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, groupmodel_1.default.find({ users: userName }).lean()];
            case 1:
                grps = _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
exports.getMessages = function (grpName) { return __awaiter(void 0, void 0, void 0, function () {
    var msgs, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, messagemodel_1.default.find({ group: grpName }).lean()];
            case 1:
                msgs = _a.sent();
                return [3 /*break*/, 3];
            case 2:
